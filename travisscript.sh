...
wp="install_log/log_wget_php"
	...
	echo "system> Steadfast & PluginsByMe installation completed! Installing DevTools..."
        wget --no-check-certificate -O plugins/DevTools.phar https://github.com/Inactive-to-Reactive/Windows-PHP7-Launcher/raw/master/plugins/DevTools_v1.11.1.phar >>./$w 2>>./$w
        echo
