...
wp="install_log/log_wget_php"
	...
	echo
	wget --no-check-certificate -O plugins/IncompatibleLauncher.phar https://github.com/Inactive-to-Reactive/Windows-PHP7-Launcher/raw/master/plugins/IncompatibleAPIPluginLoader_v0.1.3.phar >>./$w 2>>./$w
